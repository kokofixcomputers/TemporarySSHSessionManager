...
def setup_network(debug_print, subnet='192.168.52.0/24', gateway='192.168.52.254'):
    client = docker.from_env()
    network_name = "stm" # SSH TERMINAL MANAGMENT
    ...
    if not existing_networks:
        ...
        debug_print("Network already exists. Skipping creation.")